...
<title>Seafood and Fish Recipes</title>
<link rel="stylesheet" type="text/css" href="css/seafoodRecipes.css">
</head>
<body>
	<div class="header">
	...
	<h2>Seafood and Fish Recipes</h2>
	<%
      ...
      while(rs.next()){
    	  if(rs.getString(8).equals("Seafood")){
      %>
	<div class="gallery">
